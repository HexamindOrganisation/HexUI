...
Usage:
    python verify_backend.py http://127.0.0.1:8080
    python verify_backend.py http://127.0.0.1:8080 --agent echo
...
async def main() -> int:
    ...
    ap.add_argument("base_url", help="Base URL of the running backend, e.g. http://127.0.0.1:8080")
