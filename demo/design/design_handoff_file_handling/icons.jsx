...
const Icons = {
  ...
  x:       (p) => <I d="M6 6l12 12M18 6 6 18" {...p} />,
  trash:   (p) => <I {...p}><path d="M4.5 6.5h15M9 6.5V5a1.5 1.5 0 0 1 1.5-1.5h3A1.5 1.5 0 0 1 15 5v1.5M6.5 6.5l.8 12a1.5 1.5 0 0 0 1.5 1.4h6.4a1.5 1.5 0 0 0 1.5-1.4l.8-12"/><path d="M10 10.5v6M14 10.5v6"/></I>,
  upload:  (p) => <I {...p}><path d="M12 15.5V4M8 7.5 12 3.5l4 4"/><path d="M4.5 14.5v3A2.5 2.5 0 0 0 7 20h10a2.5 2.5 0 0 0 2.5-2.5v-3"/></I>,
  code:    (p) => <I d="m9 8-4 4 4 4M15 8l4 4-4 4M13.5 5.5 10.5 18.5" {...p} />,
  sheet:   (p) => <I {...p}><rect x="4" y="4" width="16" height="16" rx="2"/><path d="M4 9.5h16M4 14.5h16M9.5 9.5V20M14.5 9.5V20"/></I>,
};
